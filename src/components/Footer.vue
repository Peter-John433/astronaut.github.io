        ...
        <div class="container flex flex-col lg:flex-row justify-start items-start gap-x-32">
            ...
            <div class="flex flex-wrap lg:flex-row justify-start lg:justify-between items-start mt-10 gap-x-5 lg:gap-x-20">
                <div>
                    ...
                    <div class="flex flex-col gap-y-3 justify-start items-start mt-3">
                        <a href="#">Company</a>
                        <a href="#">Terms</a>
                        <a href="#">Profile</a>
                        <a href="#"></a>
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-y-3 justify-start items-start mt-3">
                        <div>
                            <span class="text-orange-500">email :</span> <a href="#">peterjeche442@gmail.com</a>
                        </div>
                        <div>
                           <span class="text-orange-500">phone :</span> <a href="#">08107421871</a>
                        </div>
                    </div>
                </div>
            </div>
